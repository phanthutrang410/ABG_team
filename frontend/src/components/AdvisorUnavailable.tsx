 ...
 * Production path uses server cookie auth (G07); GVCN case queue still needs
 * scoped list/detail APIs (G08) — do not invent client-side fixtures.
 */
  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-500">
        Hàng đợi GVCN cần API được scope phía server. Frontend không fetch toàn bộ case rồi lọc
