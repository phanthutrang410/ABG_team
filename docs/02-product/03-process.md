...
- **Bắt đầu:** đến lịch đồng bộ dữ liệu hàng tuần.
...
- **Dữ liệu đầu vào:** điểm và xu hướng điểm, chuyên cần/nghỉ có phép, hành vi học tập tổng hợp và dữ liệu mapping lớp–GVCN được cấp quyền.
- **Đầu ra:** báo cáo tuần, tín hiệu cần rà soát kèm yếu tố đóng góp, case đã được phê duyệt để bàn giao và số liệu vận hành/fairness.

### Luồng chuẩn

| Bước | Hoạt động | Chủ thể chính | Đầu ra/kiểm soát |
|:----:|:----------|:--------------|:-----------------|
| 1 | Đồng bộ dữ liệu định kỳ hàng tuần | Hệ thống + CNTT/Phòng Đào tạo | Ghi thời điểm, nguồn và trạng thái đồng bộ |
...
| 6 | Tạo báo cáo tuần cho Ban Lãnh đạo | Hệ thống | Tổng hợp tín hiệu mới, case đang theo dõi, freshness và fairness trên synthetic |
...
- tóm tắt fairness trên dữ liệu synthetic và cảnh báo nếu chênh lệch vượt ngưỡng nội bộ;
...
- Số tín hiệu mới mỗi tuần và số case tồn theo trạng thái.
...
- FPR tổng thể và chênh lệch FPR giữa các nhóm trên dữ liệu synthetic.
