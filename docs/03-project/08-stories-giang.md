...
1. Chỉ lấy thông điệp, giới hạn và screenshot từ `H12b`/`H16` và Live URL đã qua `D4r`. Skeleton claim matrix: [13-h12b-asset-copy-skeleton.md](13-h12b-asset-copy-skeleton.md).
