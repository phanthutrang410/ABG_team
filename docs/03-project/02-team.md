...
## 📊 Bảng điểm tự đánh giá (thang 1–5)

| Kỹ năng | Khánh Duy | Hoàng | Trg. Giang | Hạ Giang | Văn Hải | Thu Trang |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Xây dựng ứng dụng AI/LLM (Prompt/RAG/Agent) | 1 | **5** | 3 | 2 | 1 | 3 |
| Machine Learning / Deep Learning | **5** | **5** | 3 | 2 | 1 | 3 |
| Backend (API, Database, Docker) | 1 | **5** | 3 | 2 | 1 | 3 |
| Xử lý dữ liệu cho AI (tiền xử lý, embedding...) | **5** | **5** | 3 | 2 | 1 | 3 |
| Backend Development (API, DB, Auth) | 1 | **5** | 3 | 1 | 1 | 3 |
| Frontend Development | 1 | 3 | 3 | 2 | 1 | 3 |
| Triển khai & vận hành (Docker, Cloud, Deploy) | 1 | **5** | 3 | 1 | 1 | 3 |
| Phân tích & xác định yêu cầu | **5** | 4 | 3 | **5** | 4 | 3 |
| Business Analysis (BA) | 1 | 3 | 3 | 4 | 4 | 3 |
| Product Thinking | **5** | 4 | 4 | **5** | 4 | 3 |
| Data Analysis | **5** | 4 | 4 | **5** | 4 | 3 |
| Nghiên cứu tài liệu / Benchmark | **5** | 4 | 3 | 4 | 4 | 4 |
| Làm việc nhóm & phối hợp | **5** | 4 | **5** | 4 | 4 | **4** |
| Thuyết trình / Pitching | **5** | 3 | 4 | **5** | 4 | 3 |
| Viết tài liệu (Proposal, README, Slide...) | **5** | **5** | 4 | 4 | 4 | 3 |

> 🔎 Ghi chú: form khảo sát có 2 câu hỏi Backend khá trùng nhau ("Backend (API, Database, Docker)" và "Backend Development (API, DB, Auth)") — kết quả gần như đồng nhất cho từng người nên có thể coi là một nhóm kỹ năng "Backend".
...
- **Công nghệ:** Python, JavaScript/TypeScript · React/Next.js, Git, Firebase/Supabase, PostgreSQL/MySQL/MongoDB · PyTorch, Hugging Face, TensorFlow, Scikit-learn
- **Nguồn lực hỗ trợ:** Không có
...
- **Công nghệ:** Python, C/C++, SQL · FastAPI/Flask, React/Next.js, Docker, Git, PostgreSQL/MySQL/MongoDB · PyTorch, Hugging Face, TensorFlow, Scikit-learn, **LangChain, RAG, AI Agent, vLLM**
- **Nguồn lực hỗ trợ:** API Credits (OpenAI/Gemini/Claude), GPU/Colab/Kaggle/RunPod, Server/Cloud (VPS/Azure/AWS/GCP/Oracle), Codex/Claude/Cursor, Dataset
...
- **Công nghệ:** Python, SQL · PostgreSQL/MySQL/MongoDB · PyTorch, Scikit-learn
- **Nguồn lực hỗ trợ:** Codex/Claude/Cursor
...
- **Công nghệ:** Python, SQL · Node.js/Express · Scikit-learn
- **Nguồn lực hỗ trợ:** GPU/Colab/Kaggle/RunPod
...
- **Công nghệ:** Không có ngôn ngữ/framework/AI-ML nào được liệt kê
- **Nguồn lực hỗ trợ:** Codex/Claude/Cursor
...
- **Công nghệ:** Python, SQL · React/Next.js, FastAPI/Flask, Docker, Git · **AI Agent, PyTorch, LangChain**
- **Nguồn lực hỗ trợ:** Codex/Claude/Cursor, API Credits, GPU/Colab/Kaggle/RunPod
- **Vai trò mong muốn:** Data Engineering/Data Processing, Machine Learning, AI/LLM Development
- **Nhận xét:** Generalist có nền full-stack + tiếp cận AI Agent/LangChain, kinh nghiệm trải rộng nhiều sân chơi (hackathon, nghiên cứu, học thuật). **Vai trò phân công: hỗ trợ cùng Hoàng và Khánh Duy** ở mảng AI/LLM Dev & Data/ML — làm việc song song để lên tay nhanh dưới sự dẫn dắt kỹ thuật của hai người này.

---

## 🧩 Gợi ý phân vai trong team

| Vai trò | Người đề xuất | Lý do |
|---|---|---|
| **AI/LLM Engineer / PM / Kỹ thuật chính** | **Hoàng** (chính), Phan Thu Trang (hỗ trợ) | Hoàng: hồ sơ toàn diện nhất, kinh nghiệm RAG/LangChain/AI Agent/vLLM thực chiến, nhiều nguồn lực nhất (GPU, API key, cloud) → đủ base kỹ thuật để vừa code vừa điều phối, nên PM giao cho Hoàng. Trang: có nền AI Agent/LangChain, làm việc song song hỗ trợ mảng này |
| **ML / Research** | Bùi Khánh Duy (chính), Phan Thu Trang (hỗ trợ) | Duy: điểm ML/DL và nghiên cứu tối đa, phù hợp nghiên cứu mô hình, xử lý dữ liệu AI. Trang: hỗ trợ song song, có nền full-stack/data cơ bản |
| **Data / Backend hỗ trợ** | Nguyễn Trường Giang | Nền tảng full-stack đồng đều, đảm nhiệm data pipeline hoặc backend phụ trợ |
| **BA Lead / Product & Pitch chính** | **Trần Hạ Giang** (chính), Đậu Văn Hải (hỗ trợ) | Hạ Giang: phân tích yêu cầu, product thinking, thuyết trình đều 5đ + kinh nghiệm startup → chốt bài toán, user flow và là người pitch chính. Hải hỗ trợ phân tích nghiệp vụ |
| **Documentation / Research & Demo support** | **Đậu Văn Hải** (chính), Trần Hạ Giang (hỗ trợ) | Hải: nghiên cứu tài liệu, viết proposal/slide, data analysis đều 4đ → lo tài liệu nộp bài, benchmark, kịch bản demo, kiêm trợ lý điều phối cho Hoàng (timeline, meeting notes). Hạ Giang góp nội dung slide/pitch |

**Tóm tắt:** **Hoàng** giữ vai trò kép AI/LLM Engineer kiêm PM (đủ base kỹ thuật để điều phối), **Khánh Duy** lo ML/Research, **Thu Trang** hỗ trợ song song cùng hai người này ở mảng AI/LLM Dev & Data. **Trường Giang** phụ trách Data/Backend. Nhóm phân tích/sản phẩm chia lane bổ trợ nhau thay vì giẫm chân: **Hạ Giang** làm BA Lead & pitcher chính (điểm phân tích + thuyết trình cao nhất nhóm), **Văn Hải** lo documentation/research/kịch bản demo và trợ lý điều phối cho Hoàng — hai người hỗ trợ chéo nhau ở phần slide và phân tích nghiệp vụ.
